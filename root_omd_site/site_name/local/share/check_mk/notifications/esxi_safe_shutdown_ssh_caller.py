#!/bin/python
# Datamind Check_MK Notification plugin to call the
#  Datamind VMWare vSphere / ESXi Safe Shutdown script
...
# processing of shutdown script for multiple hosts, output log is sent
# to nohup.out file.
#
...
if __name__ == '__main__':
	...
	print "Done calling ESXi shutdown script"
